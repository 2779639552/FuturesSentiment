...
PLATFORM_KEYWORDS = {
    "xhs": [
        ...
        "燃料油期货", "低硫燃料油期货", "20号胶期货",
        "苯乙烯期货", "乙二醇期货", "塑料期货", "PP期货", "对二甲苯期货",
    ...
    "weibo": [
        ...
        "沥青", "燃料油", "低硫燃料油", "20号胶", "苯乙烯", "乙二醇", "聚丙烯", "对二甲苯",
    ...
    "zhihu": [
        ...
        "螺纹钢", "铁矿石", "焦炭", "焦煤",
        "沪铜", "黄金", "白银", "原油",
        "沥青", "橡胶", "燃料油", "低硫燃料油", "20号胶", "苯乙烯", "乙二醇", "对二甲苯",
        "豆粕", "棕榈油", "白糖",
        # 2026-09-01 扩 19 非金融品种(新增 6 品种:氧化铝/沪铅/沪锡/烧碱/线材/淀粉)
        "氧化铝", "沪铅", "沪锡", "烧碱", "线材", "淀粉",
        "股指期货", "国债期货",
    ...
    "eastmoney_guba": [
        # 东财股吧帖子普遍带"期货"后缀(与 batch_collect 同步),覆盖33品种池+稀疏品种池尾部
        # 黑色系
    ...
    # 抖音(2026-09-07 试点): 浏览器逐视频采评论,慢,词表精简
    "douyin": [
        "甲醇期货", "螺纹钢期货", "纯碱期货",
        "期货交易", "期货实盘",
    ],
